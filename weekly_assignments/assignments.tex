...
$\|\cdot\|_{b}$ is a norm on $F_b(S, X)$.
  ...
  \begin{solution}
    ...
    $X$ is complete it is a convergent sequence. It is then meaningful to talk
    of the limit of this sequence, which we denote $f(s) = \lim_{n\to\infty}
    f_n(s)$. From the Cauchy property we have that
    \begin{equation}
      \notag
